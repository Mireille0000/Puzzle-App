...
export class CanvasRendererDirective {
  ...
  styleEmptyCanvas(canvasCtx: CanvasRenderingContext2D, word: string, color: string) {
    const canvasCtxCopy = canvasCtx;
    canvasCtxCopy.fillStyle = '#5b9ab5';
    canvasCtxCopy.fill();
    canvasCtxCopy.font = 'bold 35px Arial';
    canvasCtxCopy.fillStyle = 'rgba(228, 206, 206, 0.9)';
    canvasCtxCopy.fillText(`${word}`, 55, 80);
    canvasCtxCopy.strokeStyle = `${color}`;
    canvasCtxCopy.stroke();
  }

  styleCanvasTextOnBgImage(
    ...
    const canvasCtxCopy = canvasCtx;
    canvasCtxCopy.fillStyle = 'rgba(228, 206, 206, 0.7)';
    canvasCtxCopy.fillRect(0, 25, canvasWidth, 75);
    canvasCtxCopy.fillStyle = 'rgb(90, 27, 113)';
    canvasCtxCopy.font = 'bold 35px Arial';
    canvasCtxCopy.fillText(`${word}`, 45, 80);
    canvasCtxCopy.strokeStyle = `${color}`;
    canvasCtxCopy.stroke();
  }
}
